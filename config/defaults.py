...
# ID number of GPU
_C.MODEL.DEVICE_ID = '7'
# Name of backbone
_C.MODEL.NAME = 'transformer'
# Last stride of backbone
_C.MODEL.LAST_STRIDE = 1
# Path to pretrained model of backbone
_C.MODEL.PRETRAIN_PATH = './pretrained_models/jx_vit_base_p16_224-80ecf9dd.pth'
...
_C.DATASETS.NAMES = ('pku')
# Root directory where datasets should be used (and downloaded if not found)
_C.DATASETS.ROOT_DIR = ('/omnisky3/public-datasets/ccq/PKUSketchRE-ID_V1/')
_C.DATASETS.TRIAL=1
